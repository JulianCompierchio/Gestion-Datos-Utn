  ...
  return (
    <Container>
      ...
      <Row className="justify-content-center">
        <Col md={6}>
          <div className='text-center'><h2>Profesor</h2></div>
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            ...
            <Form.Group>
              ...
              <Form.Control as="select" name="codTitulo" value={formData.codTitulo} onChange={handleChange}>
                {fetchedData2.response.map((item) => (
                  <option key={item.codTitulos} value={item.codTitulos}>
                    {item.descTitulo}
                  </option>
                ))}
              </Form.Control>
